...
В результате предоставьте ссылку на github ru.javawebinar.topjava.repository. Он должен содержать код, README.md с документацией API и парой команд curl для его тестирования (лучше - ссылка на Swagger).
